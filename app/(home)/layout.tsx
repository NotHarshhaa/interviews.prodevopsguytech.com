      ...
      // NOTE: docs link is separate to only show in home layout and not in docs layout, linkItems are passed to docs/layout.tsx
      {
        ...
        items: [
          ...
          },
          {
            ...
            url: '/docs/automation-scripting/getting-started',
          },
          {
            icon: <Cpu />,
            text: 'Best Practices',
            description: 'Best Practices',
            url: '/docs/best-practices/getting-started',
          },
          {
            icon: <Server />,
            text: 'Cloud',
          ...
          },
          {
            ...
            text: 'CI/CD',
            description: 'CI/CD',
            url: '/docs/ci-cd/getting-started',
          },
          {
            icon: <LayoutIcon />,
            text: 'Containers',
          ...
          },
          {
            ...
            url: '/docs/core-concepts/getting-started',
          },
          {
            icon: <LayoutIcon />,
            text: 'Infrastructure as Code',
            description: 'Infrastructure as Code',
            url: '/docs/infrastructure-as-code/getting-started',
          },
          {
            icon: <LayoutIcon />,
            text: 'Mock Interviews',
            description: 'Mock Interviews',
            url: '/docs/mock-interviews/getting-started',
          },
          {
            icon: <LayoutIcon />,
            text: 'Networking & Security',
            description: 'Networking & Security',
            url: '/docs/networking-security/getting-started',
          }
        ],
      },
      // {
